...
import com.herig.rpcfx.api.RpcfxResolver;
import com.herig.rpcfx.api.RpcfxResponse;
import com.herig.rpcfx.api.ServiceProviderDesc;
import com.herig.rpcfx.demo.api.UserService;
import com.herig.rpcfx.server.RpcfxInvoker;
...
//		registerService(client, orderService);
	...
	@Bean(name = "com.herig.rpcfx.demo.api.UserService")
